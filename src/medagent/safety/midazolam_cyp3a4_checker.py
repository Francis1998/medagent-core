"""Midazolam + Strong CYP3A4 Inhibitor Sedation safety checker.
...
_PRIMARY_AGENTS: Final[dict[str, str]] = {
    "midazolam": "a short-acting benzodiazepine metabolized by CYP3A4",
    "versed": "a midazolam brand benzodiazepine sedative",
}
...
_PARTNER_AGENTS: Final[dict[str, tuple[str, Severity]]] = {
    ...
    "nefazodone": (
        "a strong CYP3A4-inhibiting antidepressant",
        Severity.CRITICAL,
    ),
}
...
class MidazolamCyp3a4Checker:
    """Flag midazolam CYP3A4 co-prescription risks."""

    def check(self, medications: list[Medication]) -> list[MidazolamCyp3a4Risk]:
        ...
        if not primary_matches or not partner_matches:
            logger.info("midazolam_cyp3a4_checked", findings=0)
            return []
        ...
        findings: list[MidazolamCyp3a4Risk] = []
        ...
        logger.info("midazolam_cyp3a4_checked", findings=len(findings))
        return findings
    ...
    def _build_rationale(
        *,
        ...
        return (
            ...
            "Strong CYP3A4 inhibition can elevate midazolam exposure and "
            "prolong sedation / respiratory depression. Obtain urgent "
