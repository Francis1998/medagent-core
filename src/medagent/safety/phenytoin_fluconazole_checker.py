...
(nystagmus, ataxia, seizures).  Higher fluconazole doses carry greater
inhibition.  Distinct from warfarin-azole and other CYP2C9 checkers.
"""
...
_PRIMARY_AGENTS: Final[dict[str, str]] = {
    "phenytoin": "a CYP2C9-metabolised antiepileptic",
    "dilantin": "a phenytoin brand antiepileptic",
    "phenytek": "a phenytoin extended-release brand",
    "fosphenytoin": "a phenytoin prodrug for parenteral use",
    "cerebyx": "a fosphenytoin brand",
}

_PARTNER_AGENTS: Final[dict[str, tuple[str, Severity]]] = {
    "fluconazole": (
        "a CYP2C9-inhibiting azole antifungal",
        Severity.HIGH,
    ),
    "diflucan": (
        "a fluconazole brand azole antifungal",
        Severity.HIGH,
    ),
}
...
class PhenytoinFluconazoleChecker:
    """Flag Phenytoin + Fluconazole pairs."""

    def check(self, medications: list[Medication]) -> list[PhenytoinFluconazoleRisk]:
        ...
        if not primary_matches or not partner_matches:
            logger.info("phenytoin_fluconazole_checker_checked", findings=0)
            return []
        ...
        findings: list[PhenytoinFluconazoleRisk] = []
        ...
        logger.info("phenytoin_fluconazole_checker_checked", findings=len(findings))
        return findings
    ...
    def _build_rationale(
        *,
        ...
        return (
            ...
            "Fluconazole inhibits CYP2C9 and can increase phenytoin serum "
            "concentrations, raising the risk of nystagmus, ataxia, and seizures."
