"""Cyclosporine + Statin Myopathy / Rhabdomyolysis safety checker.
...
_PRIMARY_AGENTS: Final[dict[str, str]] = {
    "cyclosporine": "a calcineurin inhibitor immunosuppressant and OATP/CYP3A4 modulator",
    "ciclosporin": "a cyclosporine spelling variant calcineurin inhibitor",
    "neoral": "a cyclosporine brand calcineurin inhibitor",
    "sandimmune": "a cyclosporine brand calcineurin inhibitor",
    "gengraf": "a cyclosporine brand calcineurin inhibitor",
}

_PARTNER_AGENTS: Final[dict[str, tuple[str, Severity]]] = {
    "simvastatin": (
        "an HMG-CoA reductase inhibitor with high CYP3A4/OATP dependence",
        Severity.CRITICAL,
    ),
    "zocor": (
        "a simvastatin brand HMG-CoA reductase inhibitor",
        Severity.CRITICAL,
    ),
    "lovastatin": (
        "an HMG-CoA reductase inhibitor with high CYP3A4 dependence",
        Severity.CRITICAL,
    ),
    "mevacor": (
        "a lovastatin brand HMG-CoA reductase inhibitor",
        Severity.CRITICAL,
    ),
    "atorvastatin": (
        "an HMG-CoA reductase inhibitor (statin)",
        Severity.HIGH,
    ),
    "lipitor": (
        "an atorvastatin brand HMG-CoA reductase inhibitor",
        Severity.HIGH,
    ),
}
...
class CyclosporineStatinChecker:
    """Flag cyclosporine + statin co-prescription risks."""

    def check(self, medications: list[Medication]) -> list[CyclosporineStatinRisk]:
        ...
        if not primary_matches or not partner_matches:
            logger.info("cyclosporine_statin_checked", findings=0)
            return []
        ...
        findings: list[CyclosporineStatinRisk] = []
        ...
        logger.info("cyclosporine_statin_checked", findings=len(findings))
        return findings
    ...
    def _build_rationale(
        *,
        ...
        return (
            ...
            "Cyclosporine can increase statin exposure and intensify myopathy "
            "and rhabdomyolysis risk. Obtain urgent qualified clinical and "
