...
_PRIMARY_AGENTS: Final[dict[str, str]] = {
    "pimozide": "a typical antipsychotic with QT prolongation risk",
    "orap": "a pimozide brand antipsychotic with QT prolongation risk",
}
...
class PimozideCyp3a4Checker:
    """Flag Pimozide + Strong CYP3A4 pairs."""

    def check(self, medications: list[Medication]) -> list[PimozideCyp3a4Risk]:
        ...
        if not primary_matches or not partner_matches:
            logger.info("pimozide_cyp3a4_checker_checked", findings=0)
            return []
        ...
        findings: list[PimozideCyp3a4Risk] = []
        ...
        logger.info("pimozide_cyp3a4_checker_checked", findings=len(findings))
        return findings
